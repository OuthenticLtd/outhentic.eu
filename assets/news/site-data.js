/* Outhentic — site-wide editable content.
 *
 * This file is the single source of truth for content that's easy to update:
 * hero sections, band members, gallery photos, social URLs, contact info.
 *
 * Edit it by hand, OR use editor.html which gives you a form UI.
 *
 * After editing, upload this file to assets/news/site-data.js on your host
 * and the site updates instantly.
 */
window.OUTHENTIC_SITE = {
  /* Social links — used in every page footer */
  social: {
  ...
  groupMembers: [
    {
      ...
      name_en: "Zhivko Vasilev",          name_bg: "Живко Василев",
      role_en: "Kaval · Piano",            role_bg: "Кавал · Пиано",
    ...
    },
    {
      ...
      name_en: "Rayna Vasileva",           name_bg: "Райна Василева",
      role_en: "Vocal",                    role_bg: "Вокал",
    ...
    },
    {
      ...
      name_en: "Borislav Iliev",           name_bg: "Борислав Илиев",
      role_en: "Guitar · Tamboura",        role_bg: "Китара · Тамбура",
    ...
    },
    {
      ...
      name_en: "Stoil Ivanov",             name_bg: "Стоил Иванов",
      role_en: "Drums · Percussion",       role_bg: "Барабани · Перкусии",
  ...
  foundationMembers: [
    {
      photo: "assets/img/band/zhivko.jpg",
      name_en: "Zhivko Vasilev",  name_bg: "Живко Василев",
      role_en: "Co-founder",       role_bg: "Съосновател",
    ...
    {
      photo: "",
      name_en: "Alexandrina Vasileva",  name_bg: "Александрина Василева",
      role_en: "Co-founder · Finance",  role_bg: "Съосновател · Финанси",
  ...
  /* Gallery photos shown on group.html (Live section) */
  gallery: [
