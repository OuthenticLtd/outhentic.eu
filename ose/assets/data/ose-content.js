...
window.OSE_CONTENT = {
  ...
  "hero": {
    ...
    "title_c": "",
    "lead": "OSE is an Android instrument and toolkit for people who play. Synth, recorder, piano roll, metronome, tuner — eight focused tools that travel with the player and complement, never replace, the desktop DAW you already use.",
  ...
  "pitch": {
    "eyebrow": "Why OSE",
    "title": "Built for people who play.",
    "body_html": "<p>Most mobile music apps are built for people who tap a beat, hum into a microphone or hand the song over to a model. OSE is built for the ones who put hours into their hands — gigging keyboard players, songwriters, students past the basics, producers who keep a phone in their pocket for the moments a desktop DAW can't reach.</p><p>A real synth, a real metronome, a real tuner — designed to travel with the player. Not a DAW. Not a toy. Music tools that work.</p>"
  },

  "highlights": [
    {
      "title": "OseSynth — the in-house engine",
      "body": "A native C++ synth engine, built from scratch. Five voices ship at launch (Outhentic Synth, Bass, Keys, Pad, Pluck), with paid sound packs and any SoundFont you import on top."
    },
    {
      "title": "Layer two voices. Split the keyboard.",
      "body": "Two instruments in one preset, side by side or stacked. Be the whole band — left hand bass, right hand pad, all from the same screen."
    },
    {
      "title": "Drop a SoundFont, hear it instantly",
      "body": "Free SoundFont libraries cover almost every instrument ever recorded — pianos, organs, sitars, accordions. OSE plays .sf2 and .sf3 files straight off your storage."
    },
    {
      "title": "Phone-first, not desktop-shrunk",
      "body": "Every control is sized for thumbs and stylus. Landscape and portrait are treated as first-class — neither is an afterthought. Built to travel with the player."
    },
    {
      "title": "MIDI Learn for the stage",
      "body": "Long-press any knob, hit a key on your controller, done. Bindings are global and channel-aware — set up once, gig with confidence."
    },
    {
      "title": "Slow it down without changing the pitch",
      "body": "Practice mode plays any audio at 50–200% with phase-locked stretch. Drill a riff at 70%, learn it, ramp it back. Replaces apps like Anytune."
    }
  ],
  ...
  "modules": [
    {
      ...
      "name": "Play Module",
      "shortName": "Play",
      "tile_role": "OseSynth · layers · MIDI",
      "tagline": "OseSynth — the in-house C++ synth engine — wrapped in a keyboard you can perform on. Layer two voices, split the keyboard, drop in any SoundFont.",
      "summary": "The Play Module is OSE's instrument surface. It runs the OseSynth voice, exposes the keyboard or drum-pad layout, hosts the pitch and modulation wheels, and gives one-tap access to every other Hub — Metronome, Instrument browser, Instrument Editor, MIDI sessions, Piano Roll, Audio Editor and DSP — without leaving the keys.",
...

    {
      ...
      "name": "Audio Module",
      "shortName": "Audio",
      "tile_role": "record · takes",
      "tagline": "Capture an idea between sets. Two lenses — Recorder and Library — with a fullscreen editor for the trims and fades you actually need.",
      "summary": "The Audio Module is the capture and quick-cleanup surface. It opens with two lenses: <strong>Recorder</strong> (live capture, monitoring, signal-chain) and <strong>Library</strong> (every take you've made, ready to open in the fullscreen Audio Editor). The Recorder lens is the default. Audio quality is competitive with Lexis Audio Editor — fast, accurate, focused on what musicians actually need from a phone.",
...

    {
      ...
      "name": "MIDI Module",
      "shortName": "MIDI",
      "tile_role": "piano roll · takes",
      "tagline": "Sketch a part, refine a take, share the MIDI to whatever you open next. Stylus-first by design.",
      "summary": "The MIDI Module hosts the Piano Roll Editor and the Sessions Hub — a gallery of every MIDI take you've recorded. Designed first for the S-Pen, it works equally well on phone, tablet and DeX. Export the MIDI when you're ready to take it to your desktop DAW.",
...

    {
      ...
      "shortName": "Practice",
      "tile_role": "record · edit",
      "tagline": "Slow any audio without changing the pitch. Loop a section, transpose by semitones — drill the part, learn the song.",
      "summary": "The Practice Module is for the daily work. Drop in any audio file — a backing track, a teacher's recording, a song you're trying to cover — and slow it down without changing pitch (50–200% with phase-locked stretch), loop a hard bar, transpose by semitones. Replaces apps like Anytune, but built into the same home grid as your synth and your metronome.",
      "topbar_html": "<p>Top bar: title <strong>PRACTICE</strong> rendered in mint accent, GlowingO logo, gear icon for settings. The lens chip shows only LIBRARY — the Recorder lens is hidden in this module by design.</p>",
      "body_controls_html": "<h3>Library list</h3><p>Drop in any audio file — a backing track, a teacher's recording, a song you're trying to cover — and Practice opens it in its own gallery. Each row shows the take's name, duration and a peek of its waveform; tap a row to open it in the Audio Editor.</p><h3>Mini-visualizer</h3><p>The selected take previews above the list with a centred playhead and an <strong>OPEN</strong> pill in mint. Drag to scrub, tap OPEN to enter the fullscreen editor.</p><h3>Slow it down without changing the pitch</h3><p>The Audio Editor's TUNE fold and stretch engine are where Practice actually earns its name. Phase-locked stretch lets you play any audio at 50–200% with no pitch drift. Drill a hard riff at 70%, learn it, ramp it back up. The semitone wheel transposes whole steps. The cents slider micro-tunes for instruments slightly off concert pitch.</p><h3>Loop a section, drill it</h3><p>Toggle the Select tool, drag a region, promote it to a loop — and the loop wraps sample-perfect. The next sample after the loop end IS the loop start, no audible gap.</p><h3>Floating REC</h3><p>A red REC FAB sits at the bottom-right corner so you can capture yourself playing along without leaving the lens.</p>",
      "settings_html": "<p>Settings: SYSTEM (Auto-Rotate, Always-On) → AUDIO (input device picker, USB channel chooser when an interface is plugged in) → Practice-specific options.</p>",
      "tips_html": "<ul><li>Long-press any control to enter MIDI Learn — bind a foot pedal to start/stop the loop, for instance.</li><li>Practice shares its take library with the Audio Module; recordings made in either module appear in both. The accent colour and the hidden RECORD lens are the only visible differences.</li><li>The phase-locked stretch is the same engine the Audio Editor uses, so quality is identical to any take you've recorded in OSE.</li></ul>"
    },

    {
      ...
      "name": "Metronome",
      "shortName": "Metronome",
      "tile_role": "tap · BPM · subs",
      "tagline": "Custom time signatures, accent control, instrument-aware presets. Built to be the best metronome on Android.",
      "summary": "The Metronome is the tempo reference everything else in OSE shares. It runs as a module of its own, but the same engine drives the Play Hub's MET-arm and the Piano Roll's tempo chip. Built to be the best metronome on Android — and benchmarked against Pro Metronome and Soundbrenner, the apps that hold the title now.",
...

    {
      ...
      "shortName": "Tuner",
      "tile_role": "chromatic",
      "tagline": "Chromatic, cents-accurate. Snap-in-tune locks the readout when you're inside ±3 cents so a 1-cent wobble doesn't pull the needle around.",
...

    {
      ...
      "tile_role": "tone · sweep",
      "tagline": "Seven waveforms — four shapes plus white, pink and brown noise — with sweep mode and auto-stop.",
      "summary": "The Signal Generator is a precise audio-frequency oscillator and noise source. Use it to calibrate gear, sweep room responses, set delays by ear, train your ears, or bench-test the rest of OSE.",
...

    {
      ...
      "shortName": "Meters",
      "tile_role": "dB · FFT",
      "tagline": "FFT spectrum and SPL meter (RTA-style). For the engineer in the band.",
      "summary": "The Meters Module is the measurement surface — for the engineer in the band. Plug in a signal — microphone, instrument, or the Signal Generator — and read what's actually arriving at the converter. Use it to check a venue's room response, gain-stage at soundcheck, or just verify a signal's there.",
      "topbar_html": "<p>Top bar: module title and gear icon.</p>",
      "body_controls_html": "<h3>Meters</h3><p>The screen shows full-resolution peak and RMS bars with calibrated ballistics. Numeric peak holds and clip indicators sit alongside the bars.</p><h3>Input row</h3><p>The same input picker the rest of the modules use sits inside Settings → Audio. Built-in microphones collapse to one row; USB interfaces expose every channel.</p>",
  ...
  "homeGrid": {
    "eyebrow": "Eight tools",
    "title": "Eight tools, one home grid.",
    "body_html": "<p>Open OSE and you land on a single grid of eight tiles. No menus, no nested settings to dig through. Every tile is a complete tool.</p><p>The Play tile is emphasised because it's the most-used surface — the rest sit at uniform weight, two to a row. Tap a tile, work in that tool. Want a different one? One tap back, one tap forward.</p>"
  },
  ...
  "faq": [
    {
      "q": "Is OSE a DAW?",
      "a": "No. OSE is an Android instrument and toolkit for people who play. There is no multitrack arranger, no mixing console, no mastering chain — and that's intentional. OSE is built to <strong>complement</strong> the desktop DAW you already use, not replace it. Use OSE on the phone to sketch a part, layer two voices, slow a song down to learn it, tune up before a gig, sequence a quick MIDI idea — then take the file to your desktop DAW when you're ready to produce."
    },{
      "q": "Who is OSE for?",
      "a": "Gigging keyboard players, songwriters who play piano or keyboard, music students past the absolute-beginner stage, producers who keep a phone in their pocket for the moments a desktop DAW can't reach, cover-band members learning new songs, hobbyists who collect SoundFont files, worship-band keyboardists. The unifier: you actually play, you care about how it sounds."
    },{
      "q": "What does OSE do that the apps I already use don't?",
      "a": "Three things, roughly: a real synth (OseSynth, our own native C++ engine — not a sample-pack toy) with multi-instrument layering and any-SoundFont import; a metronome built to be the best on Android; and a phone-first piano roll designed around the S-Pen for stylus accuracy. Plus a tuner, a recorder, a slow-down practice tool, a signal generator and meters — all on one home grid."
    },{
