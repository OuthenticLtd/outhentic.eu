...
window.OSE_CONTENT = {
  ...
  "footer": {
    "tagline": "Outhentic Sound Engine. Built in Sofia, Bulgaria.",
    "columns": [
      {
        "title": "Product",
        "links": [
  ...
  "privacy_html": "<h2>Privacy policy</h2><p><em>Last updated: 10 May 2026.</em></p><p>This privacy policy explains how the Outhentic Foundation (\"we\", \"us\") handles personal data in connection with the Outhentic Sound Engine (\"OSE\", the \"App\") and the website at <code>outhentic.eu/ose</code> (the \"Site\").</p><h3>1. Who we are</h3><p>Outhentic Foundation, registered in Sofia, Bulgaria. Contact: <a href='mailto:info@outhentic.eu'>info@outhentic.eu</a>.</p><h3>2. What data the App processes</h3><p>OSE is designed to keep your data on your device. The App does not require an account. Audio recordings, MIDI files, presets and settings remain in your device's local storage (or in a folder you grant the App access to via Android's storage picker) unless you choose to share them with another app.</p><p>The App requests Android system permissions to function:</p><ul><li><strong>Microphone / audio recording</strong> — required to capture audio in the Audio Module, Tuner and Meters.</li><li><strong>Storage</strong> — required to read audio files you choose to import and to save your recordings to a folder you select.</li><li><strong>USB</strong> — required when you connect a USB audio or MIDI interface.</li></ul><p>The App does not access your contacts, location, calendar, photos or any other system resource not listed above.</p><h3>3. Data we do not collect</h3><p>The App does not collect telemetry, analytics, advertising IDs, crash dumps automatically, or any user identifier. The App does not phone home for any reason during normal operation.</p><h3>4. The website</h3><p>The Site at <code>outhentic.eu/ose</code> serves static HTML and does not set tracking cookies. We may use server access logs (kept by our hosting provider) for security and uptime monitoring; these logs include IP address, user agent and request timestamps and are kept for no longer than 30 days.</p><h3>5. Email</h3><p>If you email us at <code>info@outhentic.eu</code>, we keep the message and your email address for as long as we need to answer you and to keep a record of the conversation. We do not share it.</p><h3>6. Your rights under the GDPR</h3><p>You have the right to access, correct, erase, restrict or object to processing of your personal data, and to data portability. To exercise any of these rights, email us at <code>info@outhentic.eu</code>. You also have the right to lodge a complaint with the Bulgarian Commission for Personal Data Protection.</p><h3>7. Children</h3><p>The App is not directed at children under 13 and does not knowingly collect data from them.</p><h3>8. Changes to this policy</h3><p>If we change this policy in any material way, we'll publish the updated version at this URL and update the date at the top.</p>",

  "terms_html": "<h2>Terms of use</h2><p><em>Last updated: 10 May 2026.</em></p><h3>1. Acceptance</h3><p>By installing or using the Outhentic Sound Engine (\"OSE\") or by visiting <code>outhentic.eu/ose</code>, you accept these terms.</p><h3>2. Licence</h3><p>OSE is licensed, not sold. We grant you a non-exclusive, non-transferable, revocable licence to use OSE for personal or commercial music production on devices you own or control. You may not redistribute, decompile or sublicense the App.</p><h3>3. Your content</h3><p>Audio recordings, MIDI files, presets and any other content you create with OSE belong to you. We make no claim of ownership.</p><h3>4. Disclaimer of warranty</h3><p>OSE and the Site are provided \"as is\" without warranty of any kind, express or implied. We do not guarantee that the App will be uninterrupted, error-free, or compatible with every device and Android version.</p><h3>5. Limitation of liability</h3><p>To the maximum extent permitted by law, the Outhentic Foundation will not be liable for any indirect, incidental, special, consequential or punitive damages arising from your use of OSE or the Site, including loss of recordings or data. Always keep backups of work that matters.</p><h3>6. Third-party services</h3><p>OSE is distributed via the Google Play Store, which has its own terms.</p><h3>7. Changes</h3><p>We may update these terms; the latest version will live at this URL with the date at the top updated.</p><h3>8. Governing law</h3><p>These terms are governed by the laws of Bulgaria. Disputes will be resolved in the courts of Sofia, Bulgaria.</p><h3>9. Contact</h3><p>Questions: <a href='mailto:info@outhentic.eu'>info@outhentic.eu</a>.</p>"
};
